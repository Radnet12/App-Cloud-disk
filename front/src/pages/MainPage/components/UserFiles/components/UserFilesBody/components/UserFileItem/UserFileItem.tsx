    ...
    if (viewType === "plate") {
        return (
            <li
                className={
                    file.type === "dir"
                        ? "file-item file-item--plate"
                        : "file-item file-item--plate file-item--type-file"
                }
        ...
        <li
            className={
                file.type === "dir"
                    ...
                    : "file-item file-item--list file-item--type-file"
            }
            onClick={clickHandler}
        >
            <div className="file-item__image">
